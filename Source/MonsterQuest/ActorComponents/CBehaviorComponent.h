...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FBehaviorTypeChangedSignature, EBehaviorType, InNewType);

UCLASS( ClassGroup=(Custom), meta=(BlueprintSpawnableComponent) )
class MONSTERQUEST_API UCBehaviorComponent : public UActorComponent
{
	GENERATED_BODY()
